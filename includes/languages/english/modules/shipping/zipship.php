...
//
define('MODULE_SHIPPING_ZIPSHIP_TEXT_TITLE_1', 'Zipcode Rate');
define('MODULE_SHIPPING_ZIPSHIP_TEXT_WAY_1', 'Deliver To Zipcode: ');

define('MODULE_SHIPPING_ZIPSHIP_TEXT_TITLE_2', 'Zipcode Rate');
define('MODULE_SHIPPING_ZIPSHIP_TEXT_WAY_2', 'Deliver To Zipcode: ');

define('MODULE_SHIPPING_ZIPSHIP_TEXT_TITLE_3', 'Zipcode Rate');
define('MODULE_SHIPPING_ZIPSHIP_TEXT_WAY_3', 'Deliver To Zipcode: ');
